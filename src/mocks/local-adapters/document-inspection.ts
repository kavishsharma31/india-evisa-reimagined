...
const fixtureContracts = Object.freeze({
  ...
  'SYN-FIXTURE-BUSINESS-CARD-VALID-001': { documentType: 'SYNTHETIC_BUSINESS_CARD', scenario: 'DOCUMENT_PASS' },
  'SYN-FIXTURE-STUDENT-ADMISSION-LETTER-VALID-001': { documentType: 'SYNTHETIC_ADMISSION_LETTER', scenario: 'DOCUMENT_PASS' },
  'SYN-FIXTURE-STUDENT-FINANCIAL-SUPPORT-VALID-001': { documentType: 'SYNTHETIC_FINANCIAL_SUPPORT', scenario: 'DOCUMENT_PASS' },
  'SYN-FIXTURE-TRANSIT-TICKETS-VALID-001': { documentType: 'SYNTHETIC_TRANSIT_TICKETS', scenario: 'DOCUMENT_PASS' },
  'SYN-FIXTURE-DESTINATION-ENTRY-VALID-001': { documentType: 'SYNTHETIC_DESTINATION_ENTRY_EVIDENCE', scenario: 'DOCUMENT_PASS' },
  'SYN-FIXTURE-MISC-RELATION-PROOF-VALID-001': { documentType: 'SYNTHETIC_RELATIONSHIP_EVIDENCE', scenario: 'DOCUMENT_PASS' },
  'SYN-FIXTURE-MISC-CIVIL-CERTIFICATE-VALID-001': { documentType: 'SYNTHETIC_CIVIL_CERTIFICATE', scenario: 'DOCUMENT_PASS' },
